<!-- navigation.php -->
<nav id="menu" class="navbar navbar-expand-lg navbar-light border-bottom mb-3">
  <div class="container-fluid px-0">
    <a class="navbar-brand fs-1 " href="<?= $basePath ?>index.php">
      <span class="fw-bolder">GameRealm</span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav  ms-auto">
        <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin' && $currentPage != 'show_comments'): ?>
          <li class="nav-item">
      ...
      <ul class="navbar-nav ms-auto">
        <?php if (isset($_SESSION['username'])): ?>
          ...
          <li class="nav-item">
            <a class="nav-link <?= ($currentPage === 'logout') ? 'active' : '' ?>" href="<?= $basePath ?>users/logout.php">Log out</a>
          </li>
        <?php else: ?>
          <li class="nav-item">
